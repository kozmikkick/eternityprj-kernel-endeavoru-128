...
CPUFREQ_STATDEVICE_ATTR(overall_time_in_state, 0444, show_overall_time_in_state);
CPUFREQ_STATDEVICE_ATTR(overall_total_trans, 0444, show_overall_total_trans);
