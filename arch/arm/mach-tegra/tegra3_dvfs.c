...
#ifdef CONFIG_ETERNITYPROJECT_CPUFMAN
	CPU_DVFS("cpu_g",  4, 0, MHZ, 460, 460, 550, 550,  680,  680,  820,  970, 1100, 1150, 1200, 1240, 1280, 1320, 1360, 1500, 1600, 1700),
	CPU_DVFS("cpu_g",  4, 1, MHZ, 480, 480, 650, 650,  780,  780,  990, 1040, 1100, 1200, 1250, 1300, 1330, 1360, 1400, 1500, 1600, 1700),
	CPU_DVFS("cpu_g",  4, 2, MHZ, 520, 520, 700, 700,  860,  860, 1050, 1150, 1200, 1280, 1300, 1340, 1380, 1500, 1600, 1700),
	CPU_DVFS("cpu_g",  4, 3, MHZ, 550, 550, 770, 770,  910,  910, 1150, 1230, 1280, 1330, 1370, 1400, 1500, 1600, 1700),
#else
...
/*
 * EternityProject: Try to set the 3D frequencies like the high-end proper Tegra3.
 * Made on 12/07/2012.
 */
#ifdef CONFIG_ETERNITYPROJECT_GPUBOOST
#warning DANGEROUS!!! GPU Clocks are being boosted.
	CORE_DVFS("vde",    0, 1, KHZ,        1, 247000, 304000, 332000, 361000,  520000,  520000,  520000,  520000),
	CORE_DVFS("mpe",    0, 1, KHZ,        1, 247000, 304000, 332000, 361000,  520000,  520000,  520000,  520000),
	CORE_DVFS("2d",     0, 1, KHZ,        1, 267000, 304000, 332000, 361000,  520000,  520000,  520000,  520000),
	CORE_DVFS("epp",    0, 1, KHZ,        1, 267000, 304000, 332000, 361000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d",     0, 1, KHZ,        1, 247000, 304000, 332000, 361000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d2",    0, 1, KHZ,        1, 247000, 304000, 332000, 361000,  520000,  520000,  520000,  520000),
	CORE_DVFS("se",     0, 1, KHZ,        1, 267000, 304000, 332000, 361000,  520000,  520000,  520000,  520000),
 ...
 */
#ifdef CONFIG_ETERNITYPROJECT_GPUBOOST
	CORE_DVFS("vde",    1, 1, KHZ,        1, 247000, 304000, 332000, 361000,  520000,  520000,  520000,  520000),
	CORE_DVFS("mpe",    1, 1, KHZ,        1, 247000, 304000, 332000, 361000,  520000,  520000,  520000,  520000),
	CORE_DVFS("2d",     1, 1, KHZ,        1, 267000, 304000, 332000, 361000,  520000,  520000,  520000,  520000),
	CORE_DVFS("epp",    1, 1, KHZ,        1, 267000, 304000, 332000, 361000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d",     1, 1, KHZ,        1, 247000, 304000, 332000, 361000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d2",    1, 1, KHZ,        1, 247000, 304000, 332000, 361000,  520000,  520000,  520000,  520000),
	CORE_DVFS("se",     1, 1, KHZ,        1, 267000, 304000, 332000, 361000,  520000,  520000,  520000,  520000),
...
#ifdef CONFIG_ETERNITYPROJECT_GPUBOOST
	CORE_DVFS("cbus",   0, 1, KHZ,        1, 247000, 304000, 332000, 361000,  520000,  520000,  520000,  520000),
	CORE_DVFS("cbus",   1, 1, KHZ,        1, 247000, 304000, 332000, 361000,  520000,  520000,  520000,  520000),
#else
