...
#warning DANGEROUS!!! GPU Clocks are being boosted.
	CORE_DVFS("vde",    0, 1, KHZ,        1, 247000, 304000, 332000, 361000,  408000,  446000,  484000,  520000),
	CORE_DVFS("mpe",    0, 1, KHZ,        1, 247000, 304000, 332000, 361000,  408000,  446000,  484000,  520000),
	CORE_DVFS("2d",     0, 1, KHZ,        1, 267000, 304000, 332000, 361000,  408000,  446000,  484000,  520000),
	CORE_DVFS("epp",    0, 1, KHZ,        1, 267000, 304000, 332000, 361000,  408000,  446000,  484000,  520000),
	CORE_DVFS("3d",     0, 1, KHZ,        1, 247000, 304000, 332000, 361000,  408000,  446000,  484000,  520000),
	CORE_DVFS("3d2",    0, 1, KHZ,        1, 247000, 304000, 332000, 361000,  408000,  446000,  484000,  520000),
	CORE_DVFS("se",     0, 1, KHZ,        1, 267000, 304000, 332000, 361000,  408000,  446000,  484000,  520000),
 ...
 */
#ifdef CONFIG_ETERNITYPROJECT_GPUBOOST
	CORE_DVFS("vde",    1, 1, KHZ,        1, 247000, 304000, 332000, 361000,  408000,  446000,  484000,  520000),
	CORE_DVFS("mpe",    1, 1, KHZ,        1, 247000, 304000, 332000, 361000,  408000,  446000,  484000,  520000),
	CORE_DVFS("2d",     1, 1, KHZ,        1, 267000, 304000, 332000, 361000,  408000,  446000,  484000,  520000),
	CORE_DVFS("epp",    1, 1, KHZ,        1, 267000, 304000, 332000, 361000,  408000,  446000,  484000,  520000),
	CORE_DVFS("3d",     1, 1, KHZ,        1, 247000, 304000, 332000, 361000,  408000,  446000,  484000,  520000),
	CORE_DVFS("3d2",    1, 1, KHZ,        1, 247000, 304000, 332000, 361000,  408000,  446000,  484000,  520000),
	CORE_DVFS("se",     1, 1, KHZ,        1, 267000, 304000, 332000, 361000,  408000,  446000,  484000,  520000),
...
#ifdef CONFIG_ETERNITYPROJECT_GPUBOOST
	CORE_DVFS("cbus",   0, 1, KHZ,        1, 247000, 304000, 332000, 361000,  408000,  446000,  484000,  520000),
	CORE_DVFS("cbus",   1, 1, KHZ,        1, 247000, 304000, 332000, 361000,  408000,  446000,  484000,  520000),
#else
