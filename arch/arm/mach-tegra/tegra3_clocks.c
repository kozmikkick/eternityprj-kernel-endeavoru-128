...
#define EPRJ_MAXPLL	1800000000
#else
#define EPRJ_MAXPLL	1700000000
#endif
...
#ifdef CONFIG_ETERNITYPROJECT_CPUFMAN
#warning EternityProject: Using 1.7GHz CPUFREQ table!
/*
 * EternityProject:
 * ToDo: Implement an auto-changing easy frequency
 *       table calculation.
 */
        { 0,  102000 },
        { 1,  204000 },
